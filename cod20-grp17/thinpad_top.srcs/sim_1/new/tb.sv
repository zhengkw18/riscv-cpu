...
parameter BASE_RAM_INIT_FILE = "C:\\Users\\Clide\\Desktop\\kernel_page.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�??
parameter EXT_RAM_INIT_FILE = "C:\\Users\\Clide\\Desktop\\blank.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�??
...
// b'g\x80\x00\x00'
    ...
    #1000;
    cpld.pc_send_byte(8'h00);// b'\x00\x00\x10\x80'
    #1000;
    ...
    #1000;
    cpld.pc_send_byte(8'h14);// b'\x14\x00\x00\x00'
    #1000;
    cpld.pc_send_byte(8'h00);
    #1000;
    cpld.pc_send_byte(8'h00);
    ...
    cpld.pc_send_byte(8'h00);
    #1000;
    cpld.pc_send_byte(8'h37);// b'7\x05\xc1\x7f' li a0, 0x7FC10000
    #1000;
    cpld.pc_send_byte(8'h05);
    #1000;
    cpld.pc_send_byte(8'hc1);
    #1000;
    cpld.pc_send_byte(8'h7f);
    #1000;
    cpld.pc_send_byte(8'h93);// b'\x93\x05\x10\x10' li a1, 0x101
    #1000;
    cpld.pc_send_byte(8'h05);
    #1000;
    cpld.pc_send_byte(8'h10);
    ...
    cpld.pc_send_byte(8'h10);
    #1000;
    cpld.pc_send_byte(8'h23);// b'# \xb5\x00' sw a1, 0(a0)
    #1000;
    cpld.pc_send_byte(8'h20);
    #1000;
    cpld.pc_send_byte(8'hb5);
    #1000;
    cpld.pc_send_byte(8'h00);
    #1000;
    cpld.pc_send_byte(8'h83);// b'\x83\x05\x05\x00' lb a1, 0(a0)
    #1000;
    cpld.pc_send_byte(8'h05);
    #1000;
    cpld.pc_send_byte(8'h05);
    ...
    cpld.pc_send_byte(8'h00);
    #1000;
    cpld.pc_send_byte(8'h67);// b'g\x80\x00\x00' ret
    #1000;
    cpld.pc_send_byte(8'h80);
    #1000;
    cpld.pc_send_byte(8'h00);
